    ...
    async code(cache) {
        ...
        switch(server_info) {
            ...
            case "62":
                ...
                break;
            case "63":
                result = server.channels.cache.filter((c) => c.type === "text" || c.type === "voice").size;
                break;
            case "64":
                result = server.channels.cache.filter((c) => c.type === "text").size;
                break;
            case "65":
                result = server.channels.cache.filter((c) => c.type === "voice").size;
                break;
            case "66":
                result = server.channels.cache.filter((c) => c.type === "category").size;
                break;
        }
